...
Top candidate:         <SYMBOL>  confidence=<n>/10 (from `fmp.py confidence`)  R:R=<rr_ratio>:1 (<reward_method>)
  Confidence breakdown: RS=<0-2> R:R_margin=<0-2> entry=<0-2> liquidity=<0-2> earnings=<0-2>
